const HomeRankSkeleton = () => {
  return (
    <>
      {Array.from({ length: 3 }).map((_, index) => (
        <div
          key={index}
          className="flex justify-between items-center bg-gray-0 px-3 py-2 mb-[10px] h-14 rounded-xl animate-pulse"
        >
...
export default HomeRankSkeleton;
