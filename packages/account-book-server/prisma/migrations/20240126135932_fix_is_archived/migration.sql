...
INSERT INTO "new_FinancialSource" ("accountId", "id", "isArchived", "name", "type") SELECT "accountId", "id", "isArchived", "name", "type" FROM "FinancialSource";
...
INSERT INTO "new_Category" ("accountId", "defaultCategory", "id", "isArchived", "name", "type") SELECT "accountId", "defaultCategory", "id", "isArchived", "name", "type" FROM "Category";
DROP TABLE "Category";
